...
class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case C0174R.styleable.AppCompatTheme_textAppearanceSearchResultTitle /*65*/:
                case C0174R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle /*97*/:
                    incr = 7;
                    break;
                case C0174R.styleable.AppCompatTheme_textColorSearchUrl /*67*/:
                case C0174R.styleable.AppCompatTheme_autoCompleteTextViewStyle /*99*/:
                    incr = 6;
                    break;
                case C0174R.styleable.AppCompatTheme_listPreferredItemPaddingLeft /*72*/:
                case C0174R.styleable.AppCompatTheme_colorControlActivated /*86*/:
                case C0174R.styleable.AppCompatTheme_editTextStyle /*104*/:
                case 'v':
                    incr = 1;
                    break;
                case C0174R.styleable.AppCompatTheme_textAppearanceListItem /*76*/:
                case C0174R.styleable.AppCompatTheme_textAppearanceListItemSmall /*77*/:
                case C0174R.styleable.AppCompatTheme_colorAccent /*84*/:
                case C0174R.styleable.AppCompatTheme_ratingBarStyleSmall /*108*/:
                case C0174R.styleable.AppCompatTheme_seekBarStyle /*109*/:
                case 't':
                    incr = 2;
                    break;
                case C0174R.styleable.AppCompatTheme_listChoiceBackgroundIndicator /*81*/:
                case C0174R.styleable.AppCompatTheme_colorPrimaryDark /*83*/:
                case 'q':
                case 's':
                    incr = 4;
                    break;
                case C0174R.styleable.AppCompatTheme_controlBackground /*90*/:
                case 'z':
                    path.close();
    ...
    private static void addNode(ArrayList<PathDataNode> list, char cmd, float[] val) {
        list.add(new PathDataNode(val, null));
    }
    ...
    private static void extract(String s, int start, ExtractFloatResult result) {
        ...
        for (currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case C0174R.styleable.AppCompatTheme_listDividerAlertDialog /*44*/:
                    foundSeparator = true;
                    break;
                case C0174R.styleable.AppCompatTheme_actionDropDownStyle /*45*/:
                    if (!(currentIndex == start || isPrevExponential)) {
                        foundSeparator = true;
                        result.mEndWithNegOrDot = true;
                        break;
                    }
                case C0174R.styleable.AppCompatTheme_dropdownListPreferredItemHeight /*46*/:
                    if (!secondDot) {
                        secondDot = true;
                        break;
                    }
                    ...
                    result.mEndWithNegOrDot = true;
                    break;
                case C0174R.styleable.AppCompatTheme_listPreferredItemHeight /*69*/:
                case C0174R.styleable.AppCompatTheme_buttonStyleSmall /*101*/:
                    isExponential = true;
                    break;
            }
            if (foundSeparator) {
