...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C00082 implements OnPreDrawListener {
        ...
        C00082(View view, Object obj, ArrayList arrayList, TransitionState transitionState, boolean z, Fragment fragment, Fragment fragment2) {
    ...
    class C00093 implements OnPreDrawListener {
        final /* synthetic */ int val$containerId;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ TransitionState val$state;
        final /* synthetic */ Object val$transition;

        C00093(View view, TransitionState transitionState, int i, Object obj) {
            this.val$sceneRoot = view;
            this.val$state = transitionState;
    ...
    class C01751 implements ViewRetriever {
        final /* synthetic */ Fragment val$inFragment;

        C01751(Fragment fragment) {
            this.val$inFragment = fragment;
        }
    ...
    public void run() {
        ...
        if (!this.mAddToBackStack || this.mIndex >= 0) {
            ...
            if (SUPPORTS_TRANSITIONS && this.mManager.mCurState >= OP_ADD) {
    ...
    private void setLastIn(SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments, Fragment fragment) {
        if (fragment != null) {
            ...
            if (fragment.mState < OP_ADD && this.mManager.mCurState >= OP_ADD) {
                ...
                this.mManager.moveToState(fragment, OP_ADD, OP_NULL, OP_NULL, SUPPORTS_TRANSITIONS);
            }
        }
    }
    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        ViewRetriever viewRetriever = new C01751(inFragment);
    ...
    private void prepareSharedElementTransition(TransitionState state, View sceneRoot, Object sharedElementTransition, Fragment inFragment, Fragment outFragment, boolean isBack, ArrayList<View> sharedElementTargets) {
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00082(sceneRoot, sharedElementTransition, sharedElementTargets, state, isBack, inFragment, outFragment));
    }
    ...
    private void excludeHiddenFragmentsAfterEnter(View sceneRoot, TransitionState state, int containerId, Object transition) {
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00093(sceneRoot, state, containerId, transition));
    }
